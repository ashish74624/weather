...
function Forcast() {
    ...
    const forC = async () => {
        let url = `https://cors-anywhere.herokuapp.com/http://api.weatherapi.com/v1/forecast.json?key=c7c55c62a62f4983884114352232903&q=${value}&days=5&aqi=no&alerts=no`;
