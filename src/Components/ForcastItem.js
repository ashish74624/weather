...
function ForcastItem(props) {
    return (
        <div className='relative'>
            ...
            <img className='absolute -z-20 h-36 w-36 lg:h-44 lg:w-44 overflow-hidden rounded-lg' src={`https://image-get.onrender.com/ashishkumar74624@gmail.com/Day/${props.imgText}.webp`} alt="Background" />
